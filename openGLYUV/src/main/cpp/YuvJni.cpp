...
Java_com_quectel_openglyuv_display_utils_LibYUVUtils_init(JNIEnv *env, jclass type, jint width, jint height, jint dst_width,
                                  jint dst_height) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_quectel_openglyuv_display_utils_LibYUVUtils_compressYUV(JNIEnv *env, jclass type,
...
Java_com_quectel_openglyuv_display_utils_LibYUVUtils_NV21toI420SemiPlanar(JNIEnv *env, jclass type, jbyteArray inputArray,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_quectel_openglyuv_display_utils_LibYUVUtils_cropYUV(JNIEnv *env, jclass type, jbyteArray src_, jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_quectel_openglyuv_display_utils_LibYUVUtils_yuvI420ToNV21(JNIEnv *env, jclass type, jbyteArray i420Src,
                                           jbyteArray nv21Src,
                                           jint width, jint height) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_quectel_openglyuv_display_utils_LibYUVUtils_Yuv420Scale(JNIEnv *env, jclass type,
