...
//    }
    ...
    public void initCamera(AutoFitTextureView textureView, WindowManager windowManager, int orientation,Context context,String mCameraId) {
    ...
    private void lockFocus() {
        //创建文件
        mFile = new File(getFolderPath() + "/" + getNowDate() +"_camera_"+mCameraId +".jpg");
        try {
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            Log.d(TAG,"open camera id = "+mCameraId);
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            cameraDevice.close();
            mCameraDevice = null;
            Log.d(TAG,"openCam error  cameraId = " + mCameraId + " error = " +error);
...
//                    Log.d(TAG, "process --- STATE_PREVIEW");
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                                               @NonNull CaptureRequest request,
                                               @NonNull TotalCaptureResult result) {
                    Toast.makeText(context,"照片保存在 " + mFile.getAbsolutePath(),Toast.LENGTH_SHORT).show();
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        for (Size option : choices) {
            Log.d(TAG,"support size width = " + option.getWidth()+" height = "+option.getHeight());
