...
public class YuvUtil {
    ...
    public static native void Yuv420Scale(byte[] src, int yuvFormat, int Image_Width,
                                          int Image_Height, byte[] dst, int DST_Width, int DST_Height);

    public static native byte[] NV21toI420SemiPlanar(byte[] inputArray,int width,int height);
}
