...
void SplitVURow_NEON(const uint8_t* src_uv, uint8_t* dst_u, uint8_t* dst_v,
                     int width) {
  asm volatile (
  "1:                                          \n"
    //MEMACCESS(0)
    ...
    "subs       %w3, %w3, #16                  \n"  // 16 processed per loop
    "orr        v5.8b, v3.8b, v3.8b           \n"
    "orr        v6.8b, v1.8b, v1.8b           \n"
    "orr        v3.8b, v2.8b, v2.8b           \n"
    //MEMACCESS(1)
    "st2        {v5.8b, v6.8b}, [%1], #16            \n"  // store U
    //MEMACCESS(2)
    ...
    : "+r"(src_uv),  // %0
      ...
      "+r"(width)    // %3  // Output registers
    :                       // Input registers
    : "cc", "memory", "v1", "v2", "v3", "v4", "v5", "v6"  // Clobber List
  );
}
